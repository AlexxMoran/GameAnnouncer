...
import { RegistrationRequestsApiService } from "@shared/services/api/registration-requests-api-service";
...
export class RootService {
  ...
  registrationRequestsApiService = new RegistrationRequestsApiService(this.baseApiService);
