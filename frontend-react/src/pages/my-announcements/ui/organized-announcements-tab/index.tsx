...
import { OrganizedAnnouncementsService } from "@pages/my-announcements/model/organized-announcements-service";
...
export const OrganizedAnnouncementsTab: FC = observer(() => {
  ...
  const [announcementsService] = useState(
    () => new OrganizedAnnouncementsService(announcementsApiService)
  );
  ...
  return (
    <Box display="flex" flexDirection="column" gap={8} height="100%">
      <Badge badgeContent={total} color="secondary">
        <T variant="h6">{t("texts.organizedAnnouncements")}</T>
      </Badge>
